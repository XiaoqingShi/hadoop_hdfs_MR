package hadoop_hbase.test.weibo;
...
public class WeiBo_Hbase {
	...
	public static void main(String[] args) {
		...
		// System.out.println("创建成功");
		// 5发布微博
		WeiBo_Hbase weibo = new WeiBo_Hbase();
	 ...
	 * ColumnFamily:info
	 * 
	 * ColumnLabel:用户ID-发布微博的人的用户ID ColumnValue:关注的人的微博的RowKey
	 * 
	 * Version:1000
	 */
